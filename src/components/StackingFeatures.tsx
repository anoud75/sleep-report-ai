...
export const StackingFeatures = () => {
  ...
  return (
    <div ref={sectionRef} className="relative" style={{ height: '300vh' }}>
      <section className="w-full h-screen sticky top-0 overflow-hidden bg-background">
        {/* Background Elements */}
          ...
          <div className="relative w-full max-w-4xl">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="absolute inset-0 overflow-hidden shadow-2xl rounded-3xl bg-card/90 backdrop-blur-xl border border-border" 
                  style={{
                    ...cardStyle,
                    zIndex: activeCardIndex === index ? 30 : index === 1 ? 20 : 10,
                    transform: `translateY(${
                      activeCardIndex === index ? '0px' : 
                      activeCardIndex > index ? '20px' : '40px'
                    }) scale(${
                      activeCardIndex === index ? 1 : 
                      activeCardIndex > index ? 0.95 : 0.9
                    })`,
